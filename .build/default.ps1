...
Task Package -depends Update-AssemblyInfoFiles, Restore-Packages {
	exec { . $MSBuild $SolutionFile /t:Build /v:normal /p:Configuration=$Configuration /p:RunOctoPack="true" /p:OctoPackPackageVersion="$Version" }
}
